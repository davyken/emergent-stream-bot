...
# MTN Mobile Money
MTN_MONEY_NUMBER = os.getenv("MTN_MONEY_NUMBER", "683130849")
MTN_MONEY_NAME = os.getenv("MTN_MONEY_NAME", "MBOUMEGA WASSI AÏMAN BRAYAN")
...
PLANS = {
    ...
    "premium": {
        ...
        "description": "Basic + 2 connexions • Streaming HD • Suggestion contenus • Support prioritaire",
        "emoji": "⭐"
    },
    "trial_24h": {
        "nom": "🎁 Essai gratuit 24h",
        "prix": 0,
        "description": "Accès Basic gratuit",
        "emoji": "🎁",
        "is_trial": True,
        "duree_heures": 24
    }
